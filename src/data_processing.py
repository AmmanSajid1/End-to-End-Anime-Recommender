...
class DataProcessor:
    ...
    def load_data(self,usecols):
        try:
            ...
            raise AppException("Failed to load data",sys)
    ...
    def filter_users(self,min_rating=400):
        try:
            ...
            raise AppException("Failed to filter data",sys)
    ...
    def scale_ratings(self):
        try:
            ...
            raise AppException("Failed to scale data",sys)
    ...
    def encode_data(self):
        try:
            ...
            raise AppException("Failed to encode data",sys)
    ...
    def split_data(self, test_size=1000 , random_state=43):
        try:
            ...
            raise AppException("Failed to split data",sys)
    ...
    def save_artifacts(self):
        try:
            ...
            raise AppException("Failed to save artifacts data",sys)
    ...
    def process_anime_data(self):
        try:
            ...
            raise AppException("Failed to save animje and anime_synopsis data",sys)
